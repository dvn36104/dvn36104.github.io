...
dates. The diagram below adds context from a separate dated tree.
...
<figure class="figure">
  ...
  <figcaption class="figure-caption text-center">
    The seven major living amniote lineages. This diagram was drawn with
    Matplotlib from the branch lengths in the separate TimeTree family tree
    (<code>amniotes_family.nwk</code>) used in Part B. The Myhrvold
    life-history table contains none of these divergence dates.
  </figcaption>
</figure>
