...
The five name fields behave like taxonomy links should: hundreds of
distinct values, each appearing once or twice. `measurer` is nothing like
them: a single value, `GAPSPECIES`, repeated in all 351 rows. That is a
