...
As a sub-shell fills, each possible electron count occupies one successive
position in its block. The s-block is therefore two columns wide, the d-block
is ten columns wide and the p-block is six columns wide. These are the three
blocks included across the full-width main grid, so it has
$2 + 10 + 6 = 18$ column positions: groups 1–2, 3–12 and 13–18 respectively.
