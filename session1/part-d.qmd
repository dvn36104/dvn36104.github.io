...
(Real atoms have about twenty famous exceptions, where chromium and copper
...
That lone outer electron is why sodium reacts so violently (sometimes
explosively) with water, and why it sits in the same column as lithium
and potassium, which have the same lonely arrangement.
...
is the same cycle Lothar Meyer plotted as atomic volume in 1870, and
that Mendeleev could read in 1869 from valences and atomic weights
alone, decades before anyone knew electrons existed.
:::
