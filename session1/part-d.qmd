...
Sub-shells are labelled `s`, `p`, `d` and `f`. An s sub-shell contains one
orbital, p contains three, d contains five and f contains seven. Each orbital
can hold two electrons, with opposite spins. The capacities therefore follow
before we draw any table:

| sub-shell | orbital count | calculation | maximum electrons |
|---|---:|---:|---:|
| s | 1 | $1 \times 2$ | 2 |
| p | 3 | $3 \times 2$ | 6 |
| d | 5 | $5 \times 2$ | 10 |
